    ...
    <div class="container mx-auto">
        <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
            ...
            <ul
                ...
                <li><a class="{{ Request::is('/') ? 'header_links_active' : 'header_links_default' }}"
                ...
                <li><a class="text-sm text-blue-600 font-bold" href="#">Пользователи</a></li>
                <li class="text-gray-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                        class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <li><a class="{{ Request::is('user/dashboard') ? 'header_links_active' : 'header_links_default' }}"
                        href="{{ route('user.dashboard') }}">Кабинет</a></li>
                <li class="text-gray-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
                        class="w-4 h-4 current-fill" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
