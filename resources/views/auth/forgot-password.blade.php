...
@section('content')
    @if (session('status'))
        <div class="absolute left-1/2 transform -translate-x-1/2 mt-6 flex items-center bg-blue-500 text-white text-sm font-bold px-4 py-3"
            role="alert">
    ...
    <form action="{{ route('forgot-password') }}" method="post" novalidate>
        ...
        <div class="flex items-center justify-center h-screen">
            <div class="bg-white py-6 rounded-md px-10 max-w-lg shadow-md w-1/2">
                <h1 class="text-center text-lg font-bold text-gray-500">Восстановить пароль</h1>
